...
const Areaundermajorfieldcropssch = require('./ACPDM.model');

var Areaundermajorfieldcrops = sequelize.define('areaundermajorfieldcrops', {
...
Areaundermajorfieldcrops.sync({alter: true});
console.log('Areaundermajorfieldcrops table has been successfully created, if one doesn\'t exist ');

// export Areaundermajorfieldcrops model for use in other files.
module.exports = Areaundermajorfieldcrops;